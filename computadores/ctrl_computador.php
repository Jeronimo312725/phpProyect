<?php 
    ...
    $statement->bind_param("iisssssssssssssss", $idcomputador, $idsala, $sistema_operativo, $motherboard, $ram, $velocidadram, $procesador, $tipograficos,
    $capacidaddiscoduro, $mouse, $teclado, $panelfrontal, $lectoradvd, $ventiladores, $pastatermica, $ultimomantenimiento, $salidavideo);
